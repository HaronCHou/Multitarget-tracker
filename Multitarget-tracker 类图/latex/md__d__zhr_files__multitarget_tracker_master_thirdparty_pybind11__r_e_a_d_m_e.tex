\hypertarget{md__d__zhr_files__multitarget_tracker_master_thirdparty_pybind11__r_e_a_d_m_e_autotoc_md20}{}\doxysection{pybind11 — Seamless operability between C++11 and Python}\label{md__d__zhr_files__multitarget_tracker_master_thirdparty_pybind11__r_e_a_d_m_e_autotoc_md20}
...
Think of this library as a tiny self-\/contained version of Boost.\+Python with everything stripped away that isn\textquotesingle{}t relevant for binding generation. Without comments, the core header files only require $\sim$4K lines of code and depend on Python (2.\+7 or 3.\+x, or Py\+Py2.\+7 \texorpdfstring{$>$}{>}= 5.\+7) and the C++ standard library. This compact implementation was possible thanks to some of the new C++11 language features (specifically\+: tuples, lambda functions and variadic templates). Since its creation, this library has grown beyond Boost.\+Python in many ways, leading to dramatically simpler binding code in many common situations.

Tutorial and reference documentation is provided at \href{http://pybind11.readthedocs.org/en/master}{\texttt{ http\+://pybind11.\+readthedocs.\+org/en/master}}. A PDF version of the manual is available \href{https://media.readthedocs.org/pdf/pybind11/master/pybind11.pdf}{\texttt{ here}}.\hypertarget{md__d__zhr_files__multitarget_tracker_master_thirdparty_pybind11__r_e_a_d_m_e_autotoc_md21}{}\doxysubsection{Core features}\label{md__d__zhr_files__multitarget_tracker_master_thirdparty_pybind11__r_e_a_d_m_e_autotoc_md21}
...
\end{DoxyItemize}\hypertarget{md__d__zhr_files__multitarget_tracker_master_thirdparty_pybind11__r_e_a_d_m_e_autotoc_md22}{}\doxysubsection{Goodies}\label{md__d__zhr_files__multitarget_tracker_master_thirdparty_pybind11__r_e_a_d_m_e_autotoc_md22}
In addition to the core functionality, \mbox{\hyperlink{namespacepybind11}{pybind11}} provides some extra goodies\+:


\begin{DoxyItemize}
\item Python 2.\+7, 3.\+x, and Py\+Py (Py\+Py2.\+7 \texorpdfstring{$>$}{>}= 5.\+7) are supported with an implementation-\/agnostic interface.
...
\end{DoxyItemize}\hypertarget{md__d__zhr_files__multitarget_tracker_master_thirdparty_pybind11__r_e_a_d_m_e_autotoc_md23}{}\doxysubsection{Supported compilers}\label{md__d__zhr_files__multitarget_tracker_master_thirdparty_pybind11__r_e_a_d_m_e_autotoc_md23}

\begin{DoxyEnumerate}
\item Clang/\+LLVM 3.\+3 or newer (for Apple Xcode\textquotesingle{}s clang, this is 5.\+0.\+0 or newer)
...
\item Cygwin/\+GCC (tested on 2.\+5.\+1)
\end{DoxyEnumerate}\hypertarget{md__d__zhr_files__multitarget_tracker_master_thirdparty_pybind11__r_e_a_d_m_e_autotoc_md24}{}\doxysubsection{About}\label{md__d__zhr_files__multitarget_tracker_master_thirdparty_pybind11__r_e_a_d_m_e_autotoc_md24}
This project was created by \href{http://rgl.epfl.ch/people/wjakob}{\texttt{ Wenzel Jakob}}. Significant features and/or improvements to the code were contributed by Jonas Adler, Lori A. Burns, Sylvain Corlay, Trent Houliston, Axel Huebl, @hulucc, Sergey Lyskov Johan Mabille, Tomasz Miąsko, Dean Moldovan, Ben Pritchard, Jason Rhinelander, Boris Schäling, Pim Schellart, Henry Schreiner, Ivan Smirnov, and Patrick Stewart.\hypertarget{md__d__zhr_files__multitarget_tracker_master_thirdparty_pybind11__r_e_a_d_m_e_autotoc_md25}{}\doxysubsubsection{License}\label{md__d__zhr_files__multitarget_tracker_master_thirdparty_pybind11__r_e_a_d_m_e_autotoc_md25}
